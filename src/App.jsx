...
import MovieList from "./pages/movies-list/movielist";
import Genre from "./pages/movies-category/genre";
...
import CardDetail from "./pages/movies-details/detail";
...
class App extends Component {
      ...
      switch (path) {
        case "/ui-elements/general":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'ui-elements.general' */ "./pages/rebuilds/ui-elements/General"
            );
        ...
        case "/ui-elements/icons":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'ui-elements.icons' */ "./pages/rebuilds/ui-elements/Icons"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/ui-elements/buttons":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'ui-elements.buttons' */ "./pages/rebuilds/ui-elements/Buttons"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/ui-elements/sliders":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'ui-elements.sliders' */ "./pages/rebuilds/ui-elements/Sliders"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/ui-elements/modals/:type?":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'ui-elements.modals' */ "./pages/rebuilds/ui-elements/Modals"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/forms/general":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'form.general' */ "./pages/rebuilds/forms/GeneralElements"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/forms/advanced":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'form.advanced' */ "./pages/rebuilds/forms/AdvancedElements"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/forms/formik":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'calendar' */ "./pages/new/FormikForm"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/tables/simple":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'tables.simple' */ "./pages/rebuilds/tables/SimpleTables"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/tables/data":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'tables.data' */ "./pages/rebuilds/tables/DataTables"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/tables/data-extended":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'tables.data' */ "./pages/new/DatatablesExtended"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
        case "/calendar":
          return AsyncComponent(() => {
            ...
            console.log("loading");
            const newElem = import(
              /* webpackChunkName: 'calendar' */ "./pages/rebuilds/Calendar"
            );
            this.loadedElements[path] = newElem;
            return newElem;
          });
  ...
  render() {
    return (
      <AdminLTE
        browserTitle="adminlte-2-react-examples"
        theme="black"
        footer={<Footer />}
      >
        <Navbar.Core>
          <Entry icon="fas-envelope">
            {this.messageMenu.map((p) => (
              <MessageItem {...p} />
            ))}
            {this.notificationMenu.map((p) => (
              <NotificationItem {...p} />
            ))}
          </Entry>
          <Entry
        ...
        <Sidebar.Core>
          ...
          />
          <Item icon="fas-code" text="Genre" to="/genre" />
          <Item icon="fas-code" text="Movie List" to="/movies" />

          <Item
            icon="fas-code"
            text="Examples with JSX"
            to="/examples-with-jsx"
          />
          ...
          <Item
            ...
            text="Widgets"
            icon="fa-th"
            labels={[{ color: "green", text: "new", small: true }]}
          />
          ...
          <Item text="Forms" icon="fa-edit">
            ...
            <Item
              text="Formik form"
              to="/forms/formik"
              labels={[{ small: true, text: "new", color: "red" }]}
            />
          ...
          <Item text="Tables" icon="fa-table">
            ...
            <Item
              text="Data tables extended"
              to="/tables/data-extended"
              labels={[{ small: true, text: "new", color: "red" }]}
            />
          </Item>
          <Item
            ...
            icon="fa-calendar"
            labels={[
              { small: true, text: 3, color: "red" },
              { small: true, text: 17, color: "blue" },
            ]}
          />
          <Item
            to="/mailbox"
            ...
            icon="fa-envelope"
            labels={[
              { small: true, text: 12, color: "yellow" },
              { small: true, text: 16, color: "green" },
              { small: true, text: 5, color: "red" },
            ]}
          />
